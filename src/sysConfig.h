...
#define ADMIN_MODE_BUZZER_SUCCESS_ADD_DURATION_MS 100
...
#define TASK_RFID_STACK_DEPTH 2500
#define TASK_RFID_PRIORITY 3
#define TASK_MODENORMAL_STACK_DEPTH 5000
#define TASK_MODENORMAL_PRIORITY 4
#define TASK_MODEADMIN_STACK_DEPTH 5000
